import { Node, NamedImports, ClassDeclaration, CallExpression, Expression } from 'typescript';
...
export declare function findMethodCallExpressions(node: Node, prop: string, fnName: string | string[]): CallExpression[];
